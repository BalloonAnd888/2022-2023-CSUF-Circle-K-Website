<div class="format">
	<h1>Fundraising Committee</h1>
	<p>
		The Fundraising Committee is composed of a small group dedicated to the creation of wonderful
		and fun fundraising events for members to enjoy! Each position, which includes the logistical
		assistant, marketing assistant and creative assistant, work closely with each other to provide a
		memorable experience for both new and returning members of the club.
	</p>
	<div class="flex">
