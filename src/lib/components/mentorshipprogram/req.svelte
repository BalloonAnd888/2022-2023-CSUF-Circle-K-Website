<div class="text-white">
    <div class="grid pb-5 md:grid-cols-2">
        <div class="text-center pb-5">
            <h1 class="size-lg">To be a Big...</h1>
            <p class="size-md">The following requirements must be met:</p>
            <ul class="size-sm">
                <li>Dues Paid Member</li>
            </ul>
        </div>

        <div class="text-center">
            <h1 class="size-lg">To be a Little...</h1>
            <p class="size-md">The following requirements must be met:</p>
            <ul class="size-sm">
                <li>Dues Paid Member</li>
            </ul>           
