    ...
    <div class="box animate__animated animate__fadeInLeft">
        <div class="top-row">
            <div class="heading-text pb-4">
                <h1 class="size-xl">Service</h1>
            </div>

            <div class="paintingcolor text-frame shadow text">
                <h2 class="size-md text-center font-bold p-4">“…our first tenet that we follow. Givin back to our community today not tomorrow…”</h2>
                <p class="size-md text-center p-4">The first and most fundamental tenet of Circle K International is Service. Through Service, we strive to make our communities and the world a better place, one service project at a time. Here at CSUF Circle K, we provided all our members many opportunities to leave their mark and make a difference in their communities.</p> 
            </div>
        </div>
        ...
        <div class="bottom-row">
            <div class="py-4 m-auto">
                <div class="flex justify-center pb-7">
                    <a href="/aboutservice" class="button px-6 pt-2.5 pb-2 text-white font-medium leading-normal rounded shadow-md hover:shadow-lg transition duration-500 ease-in-out flex align-center">More about this tenet</a> 
                </div>

                <div class="flex justify-center pb-4">
                    <a href="/calendar" class="button px-6 pt-2.5 pb-2 text-white font-medium leading-normal rounded shadow-md hover:shadow-lg transition duration-500 ease-in-out flex align-center">Calendar</a> 
                </div> 
            </div>           
                ...
                <div id="carouselExampleIndicators" class="relative" data-te-carousel-init data-te-carousel-slide>
                    ...
                    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
                        <div class="relative float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-te-carousel-item data-te-carousel-active>
                            ...
                            <h5 class="text-xl font-semibold">Light The Night<h5>
                            </div>
                        </div>
                        ...
                        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-te-carousel-item>
                            ...
                            <div
                            class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                            <h5 class="text-xl font-semibold">El Modena<h5>
                            </div>
                        </div>
                        ...
                        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-te-carousel-item>
                            ...
                            <div
                            class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                            <h5 class="text-xl font-semibold">24 Hour Service Marathon<h5>
                            </div>
                        </div>
                    </div>
                    <button
