...
<div class="block">
	<div
		class="heading-text size-md font-bold m-auto animate__animated animate__fadeIn animate__slower"
	>
		<span class="text-center">Welcome to Circle K International at</span>
		<span class="text-center">California State University Fullerton!<span> </span></span>
	</div>
