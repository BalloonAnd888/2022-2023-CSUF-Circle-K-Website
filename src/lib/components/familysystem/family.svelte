<div class="text-white">
	...
	<p class="description size-md px-5 m-auto animate__animated animate__fadeInLeft">
		Every year, new families are created lead by a single Family Head under the guidance of our MDE
		and MDR chairs. Families are one of the many ways CSUF Circle K members can foster and develop
		closer ties with their peers. Exploring with us this term are three amazing Family Heads and
		families. Click on each portrait below to learn more about each family and whose in it!
	</p>

	<div class="list grid lg:grid-cols-3 py-20 animate__animated animate__fadeIn">
