<div class="sheets">
	<h1 class="size-xl title animate__animated animate__fadeIn animate__slow">Sheets of Paper</h1>
	<div class="md:grid grid-cols-2">
		<div class="top-content animate__animated animate__fadeInLeft">
			...
			/>
			<p class="intro">
				The Sheets of Paper are full of wonder, curiosity, and above all else...BLANK! A blank sheet
				of paper leaves for the potential for a masterpiece to be created. I hope that for each
				person, Sheet of Paper or not, that you can create your very own gallery filled with
				masterpieces of memories.
			</p>
			<p class="name pb-5"><b>~ Angelina Moonswami</b></p>
		</div>

		<div class="QA frame shadow animate__animated animate__fadeIn">
			<p class="pb-2"><u>Why did you join Circle K?</u></p>
			<p class="pb-2">
				I initially joined Circle K because I was left unfulfilled with my time in Key Club, but I
				stayed because I felt that here, I could have a place I could call my second home.
			</p>

			<p class="pb-2"><u>What's been making you stay?</u></p>
			<p class="pb-2">
				Thus far, the reason I keep returning to the club after 3 years is purely because of the
				people. Being able to to not only grow myself, but also witness the growth of others is
				something I am really passionate about.
			</p>

			<p class="pb-2"><u>What does the family system mean to you?</u></p>
			<p class="pb-2">
				The Family System to me means having a group of people that you can depend on and that you
				can get to know on a deeper level.
			</p>

			<p class="pb-2"><u>What is your favorite art piece?</u></p>
			<p class="pb-2">Light Iris by Georgia O' Keefe</p>
		</div>
	</div>
