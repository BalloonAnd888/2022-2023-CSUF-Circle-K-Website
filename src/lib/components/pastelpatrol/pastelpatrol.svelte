<div class="format">
	<h1 class="size-xl title animate__animated animate__fadeIn animate__slow">Pastel Patrol</h1>
	<div class="md:grid grid-cols-2">
		<div class="top-content animate__animated animate__fadeInLeft">
			...
			/>
			<p class="intro">
				We are Pastel Patrol! A family that runs on vibes, colors, and lots of personality quizzes.
			</p>
			<p class="name pb-5"><b>~ Zoe Amba</b></p>
		</div>
		<div class="QA frame shadow animate__animated animate__fadeIn">
			<p class="pb-2"><u>Why did you join Circle K?</u></p>
			<p class="pb-2">
				I joined because I had nothing else to do on a Thursday evening and a good friend invited me
				to come. After that, I was hooked.
			</p>

			<p class="pb-2"><u>What's been making you stay?</u></p>
			<p class="pb-2">
				I've made so many good friends along the way and with every new member batch comes new
				people to connect with. Getting to do service and fellowship with people I care about and
				love always makes giving back to the community better.
			</p>

			<p class="pb-2"><u>What does the family system mean to you?</u></p>
			<p class="pb-2">
				The family system to me presents an opportunity for people to further strengthen the bonds
				formed within the club. It allows members to connect to other members that they may not have
				otherwise as well. Overall, it's an effective way to build relationships with others.
			</p>

			<p class="pb-2"><u>What is your favorite art piece?</u></p>
			<p class="pb-2">Wheat field with Crows by Vincent Van Gogh</p>
		</div>
	</div>
